            ...
            <section class="container" style="margin-top: 150px;">
                <div class="row">
                    <div class="col-lg-4 col-lg-offset-4">
                        ...
                        <!-- Login form -->
                        <form class="panel" action="<?php echo site_url('config/proseslogin') ?>" method="post">
                            <!-- Brand -->
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group nm">
                                 ...
                                 <center><div class="mg-t-40 tx-center">Not yet a member? <a href="<?php echo site_url('config/registration'); ?>" class="tx-info">Sign In</a></div></center>
                            </div>
                        </form>
