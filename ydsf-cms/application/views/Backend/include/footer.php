        ...
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/plugins/summernote/js/summernote.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/javascript/backend/forms/wysiwyg.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/javascript/vendor.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/javascript/backend/charts/flots.js"></script>
        ...
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/plugins/xeditable/js/bootstrap-editable.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/plugins/xeditable/inputs-ext/address/address.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/plugins/xeditable/inputs-ext/typeaheadjs/lib/typeahead.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/plugins/xeditable/inputs-ext/typeaheadjs/typeaheadjs.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/javascript/backend/forms/xeditable.js"></script>
