                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-3 col-sm-1 col-md-1 pr0">
                                        <div class="panel widget">
                                            <div class="pa10">
                                                <h4 class="bold nm text-primary text-center"><?php echo $detail_info['tanggal'] ?></h4>
                                            </div>
                                            <hr class="nm">
                                            <div class="pa10 bgcolor-default">
                                                <p class="semibold nm text-default text-center"><?php echo $detail_info['tanggal']; ?></p>
                                            </div>
                                        </div>
                                    </div>
                                    <!--/ post date -->
                                ...
                                <div class="tab-content panel nm">
                                    <div class="tab-pane active pl0 pr0" id="popular">
                                        ...
                                        <div class="media-list">
                                            <a href="#" class="media border-dotted">
                    ...
                    <?php 
                        ...
                        echo base_url();?>assets/image/images/<?php echo $key->image; 
                                                ...
                                                <span class="media-body">
                                                    <!-- meta icon -->
                                                    <span class="media-meta"><?php echo $key->tanggal ?></span>
                                                    <!--/ meta icon -->
