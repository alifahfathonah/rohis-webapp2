            ...
            <div class="container-fluid">
                ...
                <div class="page-header page-header-block">
                    <div class="page-header-section">
                        <h4 class="title semibold"><span class="ico-money"></span> Pemasukan</h4>
                    </div>
                        ...
                        <div class="toolbar">
                            <ol class="breadcrumb breadcrumb-transparent nm">
                                ...
                                <button class="btn btn-danger btn-sm" data-toggle="collapse" data-target="#form-task"><span class="ico-plus-circle2"></span>Tambah</button>
                                           ...
                                           <!-- add new task form -->
                <form action="<?php echo site_url('keuangan/pemasukan_tambah');?>" class="collapse" id="form-task" data-parsley-validate method="post">
 ...
 <div id="alert" class="alert alert-success"><?php echo $this->session->flashdata('message'); ?></div>
                        ...
                        <div class="table-layout">
                            ...
                            <br><br><br><br>
                                ...
                                <div class="table-responsive">
                                    <form action="<?php echo site_url('keuangan/checkbox_pemasukan') ?>" method="post">
                                    ...
                                    <table class="table table-striped table-hover table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <?php $no=1; foreach ($pemasukan->result() as $value) {?>
                                            <tr>
                                                ...
                                                <td class="valign-top text-center"><span class="text-primary bold">
                                                    ...
                                                    <a class="btn btn-danger btn-sm" href="<?php echo site_url('keuangan/delete_one/'.$value->id) ?>" onclick="return confirm('Apakah anda yakin ingin menhapusnya ?')"><span class="ico-trash"></span></a>
                                                </span></td>
                                            </tr>
                                            <?php $no++; } ?>
                                         <tr>
                                ...
                                <div class="panel-footer">
                                    <ul class="list-table pa10">
                                        <li>
                                            <h5 class="semibold nm text-default">TOTAL KESELURUHAN PEMASUKAN</h5>
                                        </li>
                                        <li class="text-right">
                                            <?php

                                            $query = $this->db->query("SELECT SUM(saldo) as Total FROM rh_pemasukan WHERE id_rohis='".$this->session->userdata('id_rohis')."'");
                                            $data = $query->result();
                                             ?> 
            ...
            <?php foreach ($pemasukan->result() as $data){ ?>
            <div class="modal fade bs-example-modal-sm" id="myModalmd<?=$data->id; ?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
                    <div class="modal-dialog modal-md">
                      <form action="<?php echo site_url('keuangan/edit_pemasukan'); ?>" method="post">
            ...
            <?php } ?> 
              ...
              <div id="bs-modal-md" class="modal fade">
                    <div class="modal-dialog modal-md">
                     <form action="<?php echo site_url('keuangan/pemasukan_tambah'); ?>" method="post">
                        <div class="modal-content">
                            <div class="modal-header text-center">
                                <button type="button" class="close" data-dismiss="modal">×</button>
