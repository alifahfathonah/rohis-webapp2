                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        ...
                        <ul class="list-group list-group-tabs">
                            <li class="list-group-item "><a href="<?php echo site_url('profil/my_profile'); ?>"><i class="ico-user2 mr5"></i> Profile</a></li>
                            <li class="list-group-item active"><a href="#account" data-toggle="tab"><i class="ico-archive2 mr5"></i> Account</a></li>
                                    ...
                                    <div class="panel-body pt0 pb0">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" required name="nama_depan" value="<?php echo $detail['nama_depan']; ?>">
                                            </div>
                                        </div>
                                         <div class="form-group">
                                            <label class="col-sm-3 control-label">Nama Belakang</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" required name="nama_belakang" value="<?php echo $detail['nama_belakang']; ?>">
                                            </div>
                                        </div>
                                         <div class="form-group">
                                            <label class="col-sm-3 control-label">Nama Perusahaan</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" required name="nama_perusahaan" value="<?php echo $detail['nama_perusahaan']; ?>">
                                            </div>
                                        </div>
                                         <div class="form-group">
                                            <label class="col-sm-3 control-label">Negara</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" required name="negara"  value="<?php echo $detail['negara']; ?>">
                                            </div>
                                        </div>
                                         <div class="form-group">
                                            <label class="col-sm-3 control-label">Alamat1</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" required name="alamat1"  value="<?php echo $detail['alamat1']; ?>">
                                            </div>
                                        </div>
                                         <div class="form-group">
                                            <label class="col-sm-3 control-label">Alamat2</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" required name="alamat2"  value="<?php echo $detail['alamat2']; ?>">
                                            </div>
                                        </div>
                                         <div class="form-group">
                                            <label class="col-sm-3 control-label">Kota</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" required name="kota"  value="<?php echo $detail['kota']; ?>">
                                            </div>
                                        </div>
                                         <div class="form-group">
                                            <label class="col-sm-3 control-label">Provinsi</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" required name="provinsi"  value="<?php echo $detail['provinsi']; ?>">
                                            </div>
                                        </div>
                                         <div class="form-group">
                                            <label class="col-sm-3 control-label">Kode Pos</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" required name="kode_pos"  value="<?php echo $detail['kode_pos']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="panel-footer">
