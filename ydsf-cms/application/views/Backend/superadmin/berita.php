                ...
                <div class="page-header page-header-block">
                    ...
                    <div class="page-header-section">
                        ...
                        <!--/ Toolbar -->
                              ...
                              <form action="<?php echo site_url('akses_superadmin/tambah_berita') ?>" class="collapse" id="form-task" data-parsley-validate method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="panel-toolbar pl10" style="margin-bottom: 30px;margin-top:6px;">
                            ...
                            <form action="<?php echo site_url('akses_superadmin/checkbox_berita') ?>" method="post">
                                       ...
                                       <div class="checkbox custom-checkbox nm">  
                                          ...
                                          <label for="customcheckbox-one<?php echo"$no";?>"></label>   
                                            ...
                                            <td><?php echo $key->tanggal; ?></td>
                                             <td>
                                    <a class="btn btn-danger btn-xs" href="<?php echo site_url('akses_superadmin/delete_one/'.$key->id) ?>" onclick="return confirm('apakah anda yakin ingin mengahapus nya?')"><span class="ico-remove3"></span></a>
                            ...
                            <div class="panel-body">
                                <div class="table-layout nm">
                                    ...
                                    <div class="col-xs-9">
                                        ...
                                        <p class="text-default"><?php echo word_limiter($value->konten_berita,35); ?></p>
                                        <a href="<?php echo site_url('akses_superadmin/view_detail/'.$value->id); ?>">Lihat Selengkapnya...</a>
                                    </div>
                                </div>
                            </div>
        ...
        <!--/ END Template Main -->
            ...
            <div class="modal fade bs-example-modal-sm" id="myModalmd<?=$data->id; ?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
                    <div class="modal-dialog modal-md">
                      <form action="<?php echo site_url('akses_superadmin/edit_berita'); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="modal-header text-center">
                             ...
                             <input type="hidden" name="id" required class="form-control" value="<?=$data->id;?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="konten_berita" cols="100" rows="100"><?=$data->konten_berita?></textarea>
                                </div>
                                 <div class="form-group">
                                    <label for="">Gambar</label>
                                   <div><img src="<?php echo base_url();?>assets/image/images/<?php echo $data->image; ?>" height="100px" width="100px;" alt="" class='img4'></div>
                                </div>
