                ...
                <form action="<?php echo site_url('akses_superadmin/add_rohis');?>" class="collapse" id="form-task" data-parsley-validate method="post">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <label class="control-label">BG Data</label>
                                 <input type="text" name="bg_data" class="form-control" placeholder="Masukan BG Data">
                            </div>
                        </div>
                    </div>                    
                    <div class="form-group">
                    ...
                    <div class="modal-dialog modal-md">
                      <form action="<?php echo site_url('akses_superadmin/edit_rohis'); ?>" method="post">
                        <div class="modal-content">
                            ...
                            <div class="form-group">
                                <label for="">BG Data</label>
                                <input type="text" name="bg_data" class="form-control" value="<?=$data->bg_data?>">
                            </div>
                           
                              <div class="form-group">
                                <label class="control-label">Aktifitas Akademis</label>
                                <div >
                                  <select data-placeholder="Pilih Aktiitas Akademis" placeholder="Pilih Aktiitas Akademis"  name="hakakses" required class="select-clear form-control">
                                    <option value="">-- Pilih --</option>
                                    <option value="superadmin" <?php if($data->hakakses =='superadmin'){echo "selected";} ?>>Super Admin</option>
            ...
            <?php } ?> 
              ...
              <div id="bs-modal-md" class="modal fade">
                    <div class="modal-dialog modal-md">
                     ...
                     <div class="form-group">
                                <label class="control-label">BG Data</label>
                                <input name="bg_data" type="text" required class="form-control" placeholder="Masukan BG Data">
                    </div>
